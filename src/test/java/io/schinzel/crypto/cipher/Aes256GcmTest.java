...
public class Aes256GcmTest {
    ...
    public void create_KeyArg_HexEncoding() {
        io.schinzel.crypto.cipher.Aes256Gcm aes256Gcm = io.schinzel.crypto.cipher.Aes256Gcm.create("0123456789abcdef0123456789abcdef");
    ...
    public void create_KeyArg_DefaultArgHex() {
        ...
        assertThat(io.schinzel.crypto.cipher.Aes256Gcm.create(key).getKey()).containsExactly(UTF8.getBytes(key));
    }


    @Test
    public void constructor_KeyNonAsciiAndThusNo32Chars_ShouldStillWork() {
        io.schinzel.crypto.cipher.Aes256Gcm aes = new io.schinzel.crypto.cipher.Aes256Gcm("ĄąŚśŹźŻżĄąŚśŹźŻż");
    ...
    public void encrypt_OneStringEncryptedTwice_EncryptedStringsShouldDiffer() {
        io.schinzel.crypto.cipher.Aes256Gcm aes = new io.schinzel.crypto.cipher.Aes256Gcm("0123456789abcdef0123456789abcdef");
        String clearText = "This is a text";
        assertNotEquals(aes.encrypt(clearText), aes.encrypt(clearText));
    }
    ...
    public void constructor_WrongKeySize_ThrowException() {
        ...
        new io.schinzel.crypto.cipher.Aes256Gcm("ThisIsTheKey");
    }
    ...
    public void constructor_ByteArrEmptyKey_ThrowException() {
        exception.expect(RuntimeException.class);
        new io.schinzel.crypto.cipher.Aes256Gcm(new byte[]{}, Encoding.BASE64);
    }
    ...
    public void constructor_ByteArrNullKey_ThrowException() {
        exception.expect(RuntimeException.class);
        new io.schinzel.crypto.cipher.Aes256Gcm((byte[]) null, Encoding.BASE64);
    }
    ...
    public void constructor_NullKey_ThrowException() {
        ...
        new io.schinzel.crypto.cipher.Aes256Gcm(null);
    }
    ...
    public void encryptAndDecrypt_FunnyCharsAvailableEncodings_ShouldBeTheSame() {
        for (Encoding encoding : Encoding.values()) {
            io.schinzel.crypto.cipher.Aes256Gcm aes = new io.schinzel.crypto.cipher.Aes256Gcm("0123456789abcdef0123456789abcdef", encoding);
