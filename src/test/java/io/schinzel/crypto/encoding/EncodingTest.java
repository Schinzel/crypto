...
public class EncodingTest {
    ...
    public void encodeDecode_FunnyCharsAllEncodings_InputSameAsOutput() {
        for (IEncoding encoding : io.schinzel.crypto.encoding.Encoding.values()) {
    ...
    public void encode_Base64HardcodedValue_HardcodedOutput() {
        String actual = io.schinzel.crypto.encoding.Encoding.BASE64.encode(UTF8.getBytes("åäö"));
    ...
    public void encode_HexHardcodedValue_HardcodedOutput() {
        String actual = io.schinzel.crypto.encoding.Encoding.HEX.encode(UTF8.getBytes("åäö"));
